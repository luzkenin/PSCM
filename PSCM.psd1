#
# Module manifest for module 'PSCM'
#
# Generated by: joseph.warren.da
#
...
RequiredModules = @(
    #@{ ModuleName = 'ConfigurationManager'; ModuleVersion = '5.1802.1082.1800' }
    @{ ModuleName = 'PSFramework'; ModuleVersion = '0.9.22.70' }
    )
